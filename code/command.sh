...
dblp_ca
python train.py --num_layers 8 --dname 'coauthor_dblp' --cuda 0 --feature_noise 0.0 --lamda 0.5 --hidden 64 --wd 0.0 --epochs 5000 --runs 10 --lalpha --lr 0.001 --alpha 0.4 --dropout 0.5 --method 'GCNII' --nh
